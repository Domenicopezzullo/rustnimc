...
out/fib_nim: fib.nim | mkdir
	nim c --cc:gcc --debuginfo -o:out/fib_nim --mm:refc  -d:danger --checks=off --opt=speed --passC:"-funroll-loops -ffast-math -O3 -flto -mtune=native -march=native" --passL:"-flto" fib.nim
